...
def st_display_pdf(images,width=400, height=600):
    ...
    st.write(f"Download My Resume here [PDF](https://github.com/Akshay-Bhasme/Python-Expertise/blob/main/python_txt/CV_Akshay_Bhasme.pdf)")
...
def main():
    ...
    if choice == "Resume":
        pdf_github_url = "https://raw.githubusercontent.com/Akshay-Bhasme/Python-Expertise/blob/main/python_txt/CV_Akshay_Bhasme.pdf"  # Replace with your GitHub PDF URL
